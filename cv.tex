...
\personalinfo{%
  ...
  \homepage{illia.danko.me}
  \mailaddress{37-700 Poland}
  \location{Przemysl, PL}
  \github{illia-danko}
...
\cvtag{Elixir} \cvtag{Javascript} \cvtag{Typescript} \cvtag{Golang} \cvtag{C} \cvtag{Clojure}
...
\cvtag{Phoenix}  \cvtag{Html} \cvtag{Sass \& Css \& Tailwindcss} \cvtag{React} \cvtag{Bash}
\cvtag{Makefile} \cvtag{CMake} \cvtag{Javascript} \cvtag{Postgresql} \cvtag{MongoDB}
\cvtag{Elasticsearch} \cvtag{ArangoDB} \cvtag{ELisp} \cvtag{Lua} \cvtag{\LaTeX{}} \cvtag{Protobuf}
\cvtag{Graphql}
...
\cvtag{Phoenix Elixir / Ecto / Tailwindcss} design and implement internal tools and services.
