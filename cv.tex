...
\personalinfo{%
  ...
  \mailaddress{Kosciuszki 51/2, Street, 78-400 Poland}
...
\cvtag{Golang} \cvtag{C} \cvtag{Javascript} \cvtag{Clojure} \cvtag{Python}
\cvtag{C++} \cvtag{Java}

\divider

\cvevent{Domain Specific Languages and Frameworks}{}{}{}

\cvtag{Bash} \cvtag{Makefile} \cvtag{CMake} \cvtag{Javascript} \cvtag{SQL
family} \cvtag{MongoDB}  \cvtag{ArangoDB} \cvtag{ELisp} \cvtag{Lua} \cvtag{Elm}
\cvtag{\LaTeX{}} \cvtag{Html} \cvtag{Sass \& Css} \cvtag{React} \cvtag{Protobuf}
